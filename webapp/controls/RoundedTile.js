...
jQuery.sap.declare("com.sofigate.products.Products.controls.RoundedTile");
// Include the CSS for the control
//jQuery.sap.includeStyleSheet("./roundedTile.css");
...
sap.m.StandardTile.extend("com.sofigate.products.Products.controls.RoundedTile", {
	metadata : {
		properties : {
